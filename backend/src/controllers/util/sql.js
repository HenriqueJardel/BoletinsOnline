module.exports = { 
    ...
    atualizarAluno: "UPDATE aluno SET ",
    ...
    atualizarDisciplina: "UPDATE disciplina SET ",
    ...
    atualizarProfessor: "UPDATE professor SET ",
    ...
    buscarBoletimPeloId: "SELECT aluno, disciplina, media, (CASE WHEN media > 7 THEN 'Aprovado' WHEN media = 0 THEN 'Notas não inseridas' WHEN media < 7  THEN 'Reprovado' END) as situacao, p1, p2, p3, p4  from (SELECT AVG((ad.p1 + ad.p2 + ad.p3 + ad.p4)/4) AS media, a.nome as aluno, d.nome as disciplina, ad.p1, ad.p2, ad.p3, ad.p4 FROM aluno_disciplina ad JOIN aluno a ON ad.aluno_id = a.id JOIN disciplina d ON ad.disciplina_id = d.id WHERE ad.ID = ",
